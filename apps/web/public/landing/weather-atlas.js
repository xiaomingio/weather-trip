...
/* 光标图标来自主项目 lucide-react：Sun / CloudRain / CloudSnow；使用 WebP 避免 SVG 光标白底 */
const weatherCursors = {
  sunny: 'url("/landing/cursors/sunny.webp") 16 16, pointer',
  rain: 'url("/landing/cursors/rain.webp") 16 16, pointer',
  snow: 'url("/landing/cursors/snow.webp") 16 16, pointer'
};
