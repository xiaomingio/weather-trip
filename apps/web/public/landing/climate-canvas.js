...
const themePalettes = {
  sunny: {
    ...
    path: '#c97968',
    cells: [
      { x: 0.78, y: 0.2, radius: 0.28, squeeze: 0.64, angle: -0.2, color: 'rgba(216, 173, 87, 0.42)', middle: 'rgba(216, 173, 87, 0.16)' },
      { x: 0.68, y: 0.62, radius: 0.34, squeeze: 0.58, angle: 0.18, color: 'rgba(109, 155, 179, 0.28)', middle: 'rgba(109, 155, 179, 0.1)' },
      { x: 0.32, y: 0.38, radius: 0.26, squeeze: 0.72, angle: 0.08, color: 'rgba(88, 123, 103, 0.32)', middle: 'rgba(88, 123, 103, 0.12)' },
      { x: 0.88, y: 0.74, radius: 0.18, squeeze: 0.66, angle: -0.26, color: 'rgba(201, 121, 104, 0.22)', middle: 'rgba(201, 121, 104, 0.08)' }
    ]
  },
  rain: {
    ...
    path: '#6d9bb3',
    cells: [
      { x: 0.78, y: 0.2, radius: 0.28, squeeze: 0.64, angle: -0.2, color: 'rgba(109, 155, 179, 0.4)', middle: 'rgba(109, 155, 179, 0.14)' },
      { x: 0.68, y: 0.62, radius: 0.34, squeeze: 0.58, angle: 0.18, color: 'rgba(88, 120, 140, 0.34)', middle: 'rgba(88, 120, 140, 0.12)' },
      { x: 0.32, y: 0.38, radius: 0.26, squeeze: 0.72, angle: 0.08, color: 'rgba(95, 130, 118, 0.28)', middle: 'rgba(95, 130, 118, 0.1)' },
      { x: 0.88, y: 0.74, radius: 0.18, squeeze: 0.66, angle: -0.26, color: 'rgba(120, 145, 160, 0.26)', middle: 'rgba(120, 145, 160, 0.08)' }
    ]
  },
  snow: {
    ...
    path: '#8aa4bc',
    cells: [
      { x: 0.78, y: 0.2, radius: 0.28, squeeze: 0.64, angle: -0.2, color: 'rgba(170, 195, 220, 0.42)', middle: 'rgba(170, 195, 220, 0.14)' },
      { x: 0.68, y: 0.62, radius: 0.34, squeeze: 0.58, angle: 0.18, color: 'rgba(150, 175, 200, 0.34)', middle: 'rgba(150, 175, 200, 0.12)' },
      { x: 0.32, y: 0.38, radius: 0.26, squeeze: 0.72, angle: 0.08, color: 'rgba(190, 205, 220, 0.36)', middle: 'rgba(190, 205, 220, 0.12)' },
      { x: 0.88, y: 0.74, radius: 0.18, squeeze: 0.66, angle: -0.26, color: 'rgba(160, 180, 200, 0.28)', middle: 'rgba(160, 180, 200, 0.1)' }
    ]
  }
};
...
function drawSoftCell(width, height, cell) {
  if (!context) return;
  const x = width * cell.x;
  const y = height * cell.y;
