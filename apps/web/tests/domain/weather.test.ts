...
import type { WeatherFilter } from 'weather-core/types';
import { applyWeatherPreset, weatherPresets } from '@/domain/weather';

const activeFilter: WeatherFilter = {
  dateWindowDays: 10,
  useTemperature: true,
  temperatureMinC: -5,
  temperatureMaxC: 45,
