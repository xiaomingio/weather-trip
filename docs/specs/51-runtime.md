...
| 命令 | 说明 |
| --- | --- |
| `npm run static:data` | 构建国家分档、城市 Wire、GeoJSON 标准化边界和筛选报告 |
...
| `npm run static:geo` | 从 Natural Earth、geoBoundaries、DataV/高德（Amap）raw 生成 `geo/world.geojson`、`geo/region-outlines.geojson` 和 `geo/countries/<C3-country>.geojson` |
